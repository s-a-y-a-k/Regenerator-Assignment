...
graph = [
    [   0, 1310,  760,  390,    0,    0,  740,    0,    0,    0,    0],  # Node 1
    [1310,    0,  550,    0,  390,    0,    0,  450,    0,    0,    0],  # Node 2
    [ 760,  550,    0,  660,  210,  390,    0,    0,    0,    0,    0],  # Node 3
    [ 390,    0,  660,    0,    0,    0,  340, 1090,    0,  660,    0],  # Node 4
    [   0,  390,  210,    0,    0,  220,    0,  300,    0,    0,  930],  # Node 5
    [   0,    0,  390,    0,  220,    0,  730,  400,  350,    0,    0],  # Node 6
    [ 740,    0,    0,  340,    0,  730,    0,    0,  565,  320,    0],  # Node 7
    [   0,  450,    0, 1090,  300,  400,    0,    0,  600,    0,  820],  # Node 8
    [   0,    0,    0,    0,    0,  350,  565,  600,    0,  730,  320],  # Node 9
    [   0,    0,    0,  660,    0,    0,  320,    0,  730,    0,  820],  # Node 10
    [   0,    0,    0,    0,  930,    0,    0,  820,  320,  820,    0]   # Node 11
]
