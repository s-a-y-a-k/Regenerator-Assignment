...
# --- MODIFIED: Final Statistics Calculation and Reporting ---
def calculate_and_print_statistics():
    ...
    max_utilization = max(slot_utilization) if slot_utilization else 0
    ...
    # g) Total Number of Regenerations --- (NEWLY ADDED) ---
    ...
    print(f"g) Total Number of Regenerations: {total_regenerations}")
