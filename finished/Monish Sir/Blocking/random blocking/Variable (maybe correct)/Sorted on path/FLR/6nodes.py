...
import math
import copy
y = random.choice([i for i in range (25,32)])
SLOTS = 10 * y

# --- NEW: Regenerator limit ---
max_regenerators_at_a_node = random.randint(1,8)
random.seed(42)
start_time = time.perf_counter()

# --- Core Network and RSA Setup ---
graph = [
    [0, 1000, 1200, 99999, 99999, 99999], [1000, 0, 600, 800, 1000, 99999],
    [1200, 600, 0, 99999, 800, 99999], [99999, 800, 99999, 0, 600, 1000],
    [99999, 1000, 800, 600, 0, 1200], [99999, 99999, 99999, 1000, 1200, 0]
]
...
print("Slots = ", SLOTS)
print("Max regenerators per node = ", max_regenerators_at_a_node)