...
max_regenerators_at_a_node = 30 # <<<<<<<<<<<<< NEW CONSTRAINT
...
def calculate_and_print_statistics():
    ...
    print("g) Regenerator Node Usage (Limit per node: {max_regenerators_at_a_node}):")
    ...
    bbr_user_formula = (total_blocked_bandwidth / total_successful_regenerated_bandwidth) if total_successful_regenerated_bandwidth > 0 else float('inf')
