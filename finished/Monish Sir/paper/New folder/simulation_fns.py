                    ...
                    if path_type == 'backup':
                        ...
                        if slot_info['status'] == 'hybrid_backup':
                            ...
                            for others in other_req_ids:
                                if others == 'G': continue # Skip guard markers
...
def run_fns_simulation(slots_limit, regen_limit):
    ...
    def get_simulation_results(
        rsa, request_log, request_id_counter, active_connections, regenerator_usage, 
...
if __name__ == "__main__":
    results = run_fns_simulation(slots_limit=700, regen_limit=3)
