...
def process_path(path, path_len, bandwidth):
    ...
    # Always attempt to find the optimal single regenerator placement, regardless of total path length.
    print("  Attempting to place one regenerator (Regenerator-Aware)...")
